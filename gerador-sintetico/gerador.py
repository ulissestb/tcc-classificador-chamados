...
problemas_por_produto = {
    "cartoes": [
        {"texto": "cartão bloqueado", "tipo": "estado", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "limite incorreto", "tipo": "estado", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "cartão recusado", "tipo": "evento", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "compra não reconhecida", "tipo": "evento", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "lançamento não autorizado", "tipo": "evento", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "bloqueio indevido do cartão", "tipo": "acao_errada", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "cobrança indevida", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "pagamento duplicado no cartão", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "estorno não realizado", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
    ],
    "emprestimos": [
        {"texto": "empréstimo não liberado", "tipo": "estado", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "saldo devedor incorreto", "tipo": "estado", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "erro no contrato do empréstimo", "tipo": "evento", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "cobrança antes do vencimento", "tipo": "evento", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "valor do empréstimo incorreto", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "juros acima do contratado", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "parcelas divergentes", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "desconto indevido", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
    ],
    "pagamentos": [
        {"texto": "pagamento pendente", "tipo": "estado", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "pagamento realizado e não compensado", "tipo": "estado", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "pagamento não processado", "tipo": "evento", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "falha na confirmação do pagamento", "tipo": "evento", "impacto": "tempo_real", "nivel_urgencia": 3},
        {"texto": "pagamento duplicado", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "cobrança duplicada", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "erro no estorno do pagamento", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "pagamento para destinatário errado", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
    ],
    "renegociacao": [
        {"texto": "parcelamento não registrado", "tipo": "estado", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "dívida renegociada ainda constando em aberto", "tipo": "estado", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "renegociação não aplicada", "tipo": "evento", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "renegociação cancelada sem aviso", "tipo": "evento", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "pagamento da renegociação não reconhecido", "tipo": "evento", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "proposta de renegociação incorreta", "tipo": "acao_errada", "impacto": "administrativo", "nivel_urgencia": 1},
        {"texto": "valor renegociado divergente", "tipo": "acao_errada", "impacto": "financeiro", "nivel_urgencia": 2},
        {"texto": "condições divergentes da proposta", "tipo": "acao_errada", "impacto": "administrativo", "nivel_urgencia": 1},
    ],
}
